...
Enemy::Enemy(Microsoft::WRL::ComPtr<ID3D12Device> dev) :Object(dev)
{
...
bool Enemy::VertexBufferInit(Microsoft::WRL::ComPtr<ID3D12Device> dev)
{
...
bool Enemy::InitPipeLine(Microsoft::WRL::ComPtr<ID3D12Device> dev)
{
	HRESULT result;
...
void Enemy::Draw(ID3D12Device * dev, ID3D12GraphicsCommandList * cmd, D3D12_VIEWPORT & view, D3D12_RECT & rect, ID3D12DescriptorHeap * wvp)
{
	//パイプラインステートの設定
